...
> OPTIONS - используется клиентским приложением для получения списка разрешенных сервером запросов.
 ...
 Только www.google.com вернул ожидаемые данные, но окработал с ошибкой 405 - Метод не поддерживается.
 www.apple.com, www.msdn.com отработали без ошибок, но Allow не вернули.
...
>HEAD - получение заголовков ресурса. При таком запросе ресурс не возваращается.
  ...
  Все сайты прислали ожидаемые ответы.
